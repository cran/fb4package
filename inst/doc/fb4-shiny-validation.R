...
## ----plot-weight, fig.cap="Daily weight: fb4package (solid) vs FB4-Shiny (dashed). Lines overlap completely."----
...
## ----plot-resid, fig.cap="Daily weight difference (package − Shiny). Scale is sub-femtogram for Method 1."----
par(mfrow = c(1, 2))
...
## ----plot-nutrients, fig.cap="Daily nitrogen and phosphorus fluxes over 180 days."----
par(mfrow = c(1, 2))
...
## ----plot-contam, fig.cap="Contaminant body burden over 180 days for three CONTEQ equations."----
